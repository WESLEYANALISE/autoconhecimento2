...
import { ArrowLeft, BookOpen, Download, ExternalLink, X, Heart, Crown } from "lucide-react";
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Tenha acesso vitalício a todos os livros, downloads em PDF e leitura offline
                  </p>
                </div>
                ...
                <div className="space-y-3 text-left">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-foreground">Download de todos os livros</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    <span className="text-sm text-foreground">Leitura offline completa</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-primary rounded-full"></div>
                    <span className="text-sm text-foreground">Acesso exclusivo a novos títulos</span>
                  </div>
                </div>
